...
<img data-src="img/paper.png" class="r-fit-text taper-fade">
...
*IHPT suggests this is positive for retention*
...
Note:
*if you gotta explain it: don't use it.* <br>
*if you use it: reference, don't re-enact*
