...
Note: Specifically, I claim that computing is the art of making meaning. I can feel some philosophers in the room bristling; this is not my intent, in fact, I need your help.
...
Note: To recap - computing has always been an art, we use abstractions to make meaning.
...
For generations, women in this field have worked to make it a more hospitable place. I can not lie to you and tell you that this work is done, and the field is ready, or promise that you will not encounter hostile idiots with something to prove. What I can promise is this - the women standing up here, the CS Kickstart leaders and myself, take the ongoing work of making computing a home for everyone seriously, and we will support you if you call on us for help. And what’s more, research has shown that the best defense against hate of this kind is community, which means that the women sitting next to you are an even greater asset than the ones standing up here. Just by coming to CS Kickstart, you are already more prepared to succeed in this field in the face of any adversity that may arise. And for that gift, I want to give our CS Kickstart leaders a round of applause.
